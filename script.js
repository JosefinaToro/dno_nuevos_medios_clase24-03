...
function setup() {
    ...
    elColor = createColorPicker("#ffcc00").parent("controles");
...
function portada() {
    ...
    select("a:nth-child(1)").style("font-weight", "bold").style("color", "#4981ff");
}
function pagina() {
    createSpan(". You are in page.html").parent("title");
    select("a:nth-child(2)").style("font-weight", "bold").style("color", "#4981ff");
}